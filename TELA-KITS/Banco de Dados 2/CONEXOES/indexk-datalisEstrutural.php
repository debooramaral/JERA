                                                            ...
                                                            <div class="linha-list-brinde">
                                                                ...
                                                                <div class="fundo-cinza-k">
                                                                        ...
                                                                        <datalist id="brindedokit">
                                                                            <?php
                                                                                ...
                                                                                while($data = mysqli_fetch_array($result)){
                                                                                    ...
                                                                                    ?>
                                                                                       <option value="<?php $id_brinde; echo $valor. ' ' .$valor3. ' ' ?>"><?php echo $valor2; ?></option>
                                                                                    <?php
                                                                                }
                                                                            ?>
                                                                        </datalist>
                                                                        ...
                                                                        <div class="quantidade-brinde">
                                                                            <input type="number" placeholder="<?php echo $valor3; ?>" name="qtdd-brinde">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="body_modal_saida">
                                            ...
                                            <div class="observacao-saida">
                                                <fieldset>
                                                    ...
                                                    <textarea name="" id="" cols="40" rows="3" style="resize: none;"></textarea>
                                                </fieldset>
                                            </div>
